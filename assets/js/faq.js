const productInfo = [
    ...
    },
    {
        ...
        answer: "Iced Tea is currently available on Amazon and at 7-Eleven. It will be available at more stores soon. If you don't see it, tell your store you want them to carry it."
    },
    {
        question: "ARE YOUR CANS RECYCLABLE?",
        answer: "Yes, our cans are infinitely recyclable. In fact, of all the aluminum produced since 1888, 75% of it is still currently in use. Compare that to plastic which basically isn't recycled anymore because it's simply not profitable. #DeathToPlastic"
    },
    {
        question: "IS THERE CAFFEINE IN LIQUID DEATH?",
        answer: "Only our Iced Teas have a microdose of natural caffeine (30mg from black tea). Our Mountain Waters and Flavored Sparkling Waters contain no caffeine. All of them will brutally murder your thirst so you can dump its body in shallow desert grave."
    },
    {
    ...
    },
    {
        ...
        answer: "First, congrats. We can't wait to meet the little demon. Second, we definitely recommend drinking Liquid Death Mountain Water while pregnant because water is even more important when you're hydrating for two. (Only our Iced Teas contain a microdose of 30mg of caffeine. Check with your doc if you have questions about caffeine.)"
    },
    {
        question: "WHAT IS THE SHELF LIFE OF LIQUID DEATH?",
        answer: "For technical reasons, the shelf life is pegged at 24 months. So you can definitely use it for your doomsday prep if that's what you're asking. 💀"
    },
    {
    ...
    },
    {
        ...
        answer: "Most bottled water on the market comes in 20 oz servings. To deliver more Liquid Death to you and thus more efficiently chainsaw your thirst to bits, we've introduced new King Size cans. You may continue to see some of the original size tallboys around for a while though."
    }
]
...
const orders = [
    ...
    {
        question: "WHAT SHOULD I DO IF I THINK MY MERCH ORDER IS LOST OR DAMAGED?",
...
const payments = [
    {
        ...
        answer: "We accept all major credit cards: Visa, Mastercard, American Express, Discover, G Pay, PayPal and Liquid Death Gift Cards. You can also pay using Klarna, which allows you to pay in four equal, interest-free installments. With Klarna, purchases above $1000 you can finance like how you would a credit card."
    },
    {
    ...
    {
        question: "CAN I USE MY LIQUID DEATH GIFT CARD TOWARDS WATER ORDERS ON AMAZON OR OTHER RETAILERS?",
    ...
    {
        question: "I FORGOT TO ENTER THE DISCOUNT CODE FOR MY ORDER. HOW CAN I GET THE DISCOUNT APPLIED?",
...
const shippingAndDelivery = [
    {
        ...
        answer: "All merch orders from our site of $85+ ship for free on the wings of two-headed demon eagles. Orders under $85 have a standard shipping rate of $6 to help pay the salary of our two-headed demon eagles."
    },
...
const rewardsProgram = [
    ...
    },
    {
        ...
        answer: "Yes. Upload a photo of your receipt within 30 days of purchase and get 5 Skulls for every receipt you upload. We'll ignore the other weird shit you bought."
    },
    {
        question: "HOW COME MY RECEIPT WAS REJECTED?",
        answer: "There are a few possibilities. Please make sure your receipt meets the following credentials, then try again. - Use a clear image. - Upload your receipt within 30 days of your purchase. -Only submit 1 receipt at a time. -The receipt cannot be from liquiddeath.com If you're still having issues, let us know here. Please include an image of your receipt."
    },
    {
        question: "CAN I REDEEM SKULLS FOR LIQUID DEATH WATER ON AMAZON?",
        answer: "Unfortunately no, but you can still trade them in for free shirts, hats, koozies, and other killer merch on liquiddeath.com 🤘"
    }
]
...
const accountAndCountryClub = [
    ...
    },
    {
        ...
        answer: 
        ` A supreme being who enjoys eternal perks because they sold their soul to us in exchange for:
...
const subscription = [
    {
        ...
        answer: "On July 5th, 2022 all Auto Death memberships were canceled. We've shifted our online water sales to Amazon where you can Subscribe & Save. Trust us. It'll save you a shitload of money. Up to $4 per case. But you have to resubscribe on Amazon yourself."
    },
    {
        question: "CAN I RENEW MY AUTO DEATH MEMBERSHIP?",
        answer: "Here's the bad news: We no longer sell water on liquiddeath.com so you can't renew your membership. Now here's the great news: If you sign up for Subscribe & Save on Amazon you'll get the same great Liquid Death you love but save up to $4 on each case. And you'll get free shipping."
    },
    {
        question: "HOW DO I CANCEL MY SUBSCRIPTION?",
        answer: "We already canceled it for you. Go to Amazon.com to Subscribe & Save there. If you need any help click here to reach our surprisingly delightful support team."
    }
]
...
const beverageOrdersNowOnAmazon = [
    {
        ...
        answer: "On July 5th, 2022 all Auto Death memberships were canceled. We've shifted our online water sales to Amazon.com where you can Subscribe & Save. Trust us. It'll save you a shitload of money. Up to $4 per case. But you have to resubscribe on Amazon yourself."
    },
    {
        question: "WHY DON'T YOU SELL LIQUID DEATH ON THE WEBSITE ANYMORE?",
        answer: "Amazon is much better at lugging heavy things to your front door so we decided to let them deal with the hard work. Plus, it'll save you a lot of money."
    },
    {
    ...
    },
    {
        ...
        answer: "In most instances, your order should not arrive with plastic packaging. Unfortunately, there may be some times when it does. For example, if you order a single case of Liquid Death along with other items they may pack the box using some plastic. The upside is that consolidating shipping with a single carrier reduces our carbon footprint significantly. This change will be an overall benefit to the environment so we thought it was worth making."
    },
    {
        question: "WHAT DO I DO IF MY ORDER FROM AMAZON NEVER ARRIVED OR IT ARRIVED DAMAGED?",
        answer: "If you go to “Returns & Orders” on Amazon.com you'll see links that can help you with that. They're very good at it."
    },
    {
        question: "CAN I SET UP A SUBSCRIPTION ON AMAZON?",
        answer: "Yes! That's a great idea. Sign up for Amazon's Subscribe & Save. You'll save 5% more on each caseand get free shipping."
    },
]
...
const sections =
{
    ...
    "section2": orders,
    "section3": payments,
    "section4": shippingAndDelivery,
    "section5": rewardsProgram,
    "section6": accountAndCountryClub,
    "section7": subscription,
    "section8": beverageOrdersNowOnAmazon
}

function faqItemHtml(sectionID, faqSections) {
    ...
    faqSections.forEach(item => {
        ...
        faqQuestion.classList.add('faqQuestion');
        faqQuestion.setAttribute('onclick', 'faqListToggle(this)');

        const questionsDiv = document.createElement('div');
        questionsDiv.classList.add('questions');

        const questionsText = document.createElement('p');
        questionsText.textContent = item.question;

        const plusIconSpan = document.createElement('span');
        plusIconSpan.classList.add('plusIcon');
        ...
        questionsDiv.appendChild(plusIconSpan);
        plusIconSpan.appendChild(plusIcon);
        faqQuestion.appendChild(questionsDiv);
